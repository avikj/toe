...
func (m *GameData) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
var fileDescriptor_f3f9980694d09f96 = []byte{
	...
	,
	...
	0xec, 0x39, 0x7d, 0x90, 0xbf, 0x2b, 0xc0, 0x64, 0x49, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0xd8,
	0xeb, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x24, 0x4a, 0xee, 0xd0, 0x11, 0x01, 0x00, 0x00,
}
...
func (m *GameData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintGameData(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x32
	}
	if m.GameId != 0 {
